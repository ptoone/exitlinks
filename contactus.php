...
<html xmlns="http://www.w3.org/1999/xhtml">
	<head>
		...
		<title>Contact ExitLinks - Converting Boring Links to Cash!</title>
...
if (parseInt(navigator.appVersion) >=5) {DOM=1};
	...
	<body>
		<?php echo $result_div; ?>
		<form action="contactus.php" onsubmit="return checkform(this);" method="post">
	...
	<div style='clear: both;'></div>
			<div id="content">
				<h2 class="first">ExitLinks Support - Contact</h2>

				If you are having any issues with the site or your account, please feel free to contact our support any time. We will make it our<br />
				priority to get a response back to you as fast as possible.
				<br /><br />
				<div class="standardForm">
					<fieldset>
						<p class="info">Please fill out all the required fields below:</p>
						<p>
						    <label for="txtUsername" style="width:25%">* Your Full Name:</label>

						    <input type="text" name="fullname" value="<?php echo $form['fullname']; ?>" size="40" />&nbsp;
						</p>
						<p>
						    <label for="txtEmail" style="width:25%">* Your Email:</label>
						    <input type="text" name="email" size="40" value="<?php echo $form['email']; ?>" />&nbsp; 
						</p>
						<p>
						    <label for="txtSubject" style="width:25%">* Message Subject:</label>

						    <?php echo $comments_textarea_1 . $comments_textarea_2; ?><?php echo $form['comments']; ?><?php echo $end_textarea_1 . $end_textarea_2; ?>&nbsp;
						</p>
						<br />
