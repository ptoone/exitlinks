...
<html xmlns="http://www.w3.org/1999/xhtml">
	<head>
		...
		<title>Forgot Your Password ExitLinks - Converting Boring Links to Cash!</title>
...
if (parseInt(navigator.appVersion) >=5) {DOM=1};
	...
	<div style='clear: both;'></div>
			<div id="content">
				<h2 class="first">Forgot my Password - ExitLinks </h2>

				If you are having any issues with logging in then please let us know!
				<br /><br />
