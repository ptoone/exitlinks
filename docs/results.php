...
<html xmlns="http://www.w3.org/1999/xhtml">
	<head>
		...
		<title>Thank You for Sending Us a Message! - ExitLinks - Converting Boring Links to Cash!</title>
...
<input type="hidden" name="login_data" id="login_data" value="DC(*@^i7dxc9w26er0@" />
			...
			<p id="notes"><strong>MESSAGE: </strong>Thanks for sending us a message! We LOVE reading e-mails from our users!</p>
			...
			<div id="head">
                ...
                <div id="login">
					<fieldset>
						...
						<p><label for="username">E-Mail Address:</label><input type="text" id="user_email" name="user_email" value="" /></p>
						<p><label for="password">Password:</label><input type="password" id="user_password" name="user_password" value="" /></p>
...
The <strong>Price is $225</strong> and can find more information here <a href="http://www.exitlinks.net">ExitLinks.net</a><br><br>
